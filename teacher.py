...
batch_t_state_h, batch_t_state_g, h_losses, g_losses = teach_agents(attn3_config, teachers)
...
if attn3_config["save_result"] == True:
	...
	save_jax_array(h_losses, f"results/{currentDate}/{model_name}", "hinters_losses")
	save_jax_array(g_losses, f"results/{currentDate}/{model_name}", "guessers_losses")
